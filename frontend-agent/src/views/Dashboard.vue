...
.ticket-list { max-height: 280px; overflow-y: auto; }
.ticket-item { display: flex; align-items: center; gap: 12px; padding: 10px 0; border-bottom: 1px solid #f0f0f0; cursor: pointer; }
.ticket-item:hover { background: #f8fafc; }
.ticket-item:last-child { border-bottom: none; }
.ticket-left { width: 4px; }
.sla-bar { width: 4px; height: 32px; border-radius: 2px; }
.ticket-body { flex: 1; min-width: 0; }
.ticket-title { font-size: 13px; color: #333; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.ticket-meta { font-size: 12px; color: #999; display: flex; gap: 12px; margin-top: 4px; }
