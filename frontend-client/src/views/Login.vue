  ...
  <div class="login-page">
    ...
    <div class="login-card">
      <div class="login-header">
        ...
        <h1>公司桌面IT服务台</h1>
        <p class="subtitle">提交工单、在线咨询、快速解决IT问题</p>
      </div>
      ...
      <el-form :model="form" @submit.prevent="handleLogin" class="login-form" ref="loginFormRef">
        <el-form-item>
          <el-input
            ...
            size="large"
            prefix-icon="User"
            @keyup.enter="$refs.loginFormRef && handleLogin()"
          />
        </el-form-item>
        <el-form-item>
          <el-input
      ...
      <div class="login-footer">
        <el-link type="primary" @click="showRegister = true" class="register-link">
          没有账号？申请注册
        </el-link>
    ...
    <!-- 注册对话框 -->
    <el-dialog v-model="showRegister" title="申请注册" width="420px" :close-on-click-modal="false" class="register-dialog">
...
.bg-circle-2 { width: 400px; height: 400px; background: #60a5fa; bottom: -150px; left: -100px; }
.bg-circle-3 { width: 200px; height: 200px; background: #93c5fd; top: 40%; left: 10%; }
...
.logo { font-size: 40px; line-height: 1; filter: brightness(0) invert(1); }
